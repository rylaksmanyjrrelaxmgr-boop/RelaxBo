...
def load_replies():
    ...
    WELCOME_REPLIES = {"مرحباً": "أهلاً وسهلاً بك في مجموعتنا 🤍", "السلام عليكم": "وعليكم السلام ورحمة الله وبركاته 🌹", "اهلاً": "أهلاً بك، تشرفنا 🙏", "هلا": "هلا والله، نورت المجموعة ✨", "مرحبا بكم": "أهلاً بكم جميعاً، تشرفنا بتواجدكم 🌸", "هلا والله": "هلا بك، نورت الدنيا 🌹", "مرحبا مليون": "مليون مرحبة، نورت ✨", "اهلا وسهلا": "أهلاً وسهلاً، حياك الله 🙏", "نورت": "نورت المجموعة بوجودك 🌸", "شرفت": "شرفتنا يا غالي 🌹", "تشرفنا": "تشرفنا بمعرفتك 🙏", "منور": "منور الدنيا يا حلو 🌸", "ياهلا": "ياهلا بك مليون 🌹", "اهلين": "أهلين وسهلين ✨", "مسا الخير": "مسا النور 🌙", "صباح الخير": "صباح النور 🌞", "تصبح على خير": "وأنت من أهله 🌙", "مساء النور": "أهلين وسهلين 🌸", "نورت الدنيا": "أنت النور 🌹", "فرحتنا": "فرحتنا بوجودك 🤍"}
    FAQ_REPLIES = {"كيف حالك": "الحمد لله، بخير وأنت؟ ❤️", "شو اخبارك": "كل الخير، كيفك أنت؟ 🌹", "اخبارك": "بخير، الحمد لله 🙏", "شنو اخبارك": "الحمد لله، كيفك أنت؟ ❤️", "شخبارك": "شخبارك أنت؟ 🌸", "وينكم": "هني موجودين، شنو المطلوب؟ 👋", "وينك": "أنا هنا، شنو تحتاج؟ 🤖", "شنو اسمك": "أنا البوت، تحت أمرك 🙏", "وش اسمك": "أنا البوت، تشرفنا 🤖", "منو انت": "أنا البوت، مساعد المجموعة 🛡️", "ايش اسمك": "اسمي البوت، سعيد بمعرفتك 🌹", "كيفك انت": "بخير الحمد لله 🌸", "وشلونك": "الحمد لله، كيفك أنت؟ ❤️", "كيف الأحوال": "كل تمام، الحمد لله 🙏", "شو وضعك": "تمام، الحمد لله 🌹", "كيف الحال": "الحال دوماً بخير 🌸", "ايش اخبارك": "الخبر كله خير ❤️", "اخبار الدنيا": "الدنيا بخير 🌹", "شو جديد": "الجديد هو وجودك معنا ✨", "ايش جديدك": "جديدك يفرحنا 🌸", "كيف اليوم": "اليوم جميل بحضورك 🌹", "شو تسوي": "أساعد الناس، وهني بانتظارك 🤖", "اين انت": "أنا هنا، تحت أمرك 🙏", "شنو تسوي": "أخدم المجموعة وأديرها 📡", "ماذا تفعل": "أساعد في إدارة المجموعة 🛡️"}
    POSITIVE_REPLIES = {"شكراً": "العفو، تحت أمرك دائماً ❤️", "شكرا": "العفو، أهلين 🙏", "تسلم": "تسلم يا غالي 🌸", "تسلمي": "تسلمي يا غالية 🌹", "يسلمو": "يسلم قلبك ❤️", "يعطيك العافية": "يعافيك ربي ❤️", "يعطيك الف عافية": "الله يعافيك 🌹", "ربي يوفقك": "وإياك يا رب 🌸", "جزاك الله خير": "وإياكم، الله يبارك فيك 🌹", "الف شكر": "ألف شكر لك 🙏", "مشكور": "مشكور يا غالي 🌸", "مشكورة": "مشكورة يا غالية 🌹", "شكراً جزيلاً": "الشكر لله ثم لك ❤️", "يعطيك الصحة": "الله يعافيك 🙏", "ربي يعطيك العافية": "يعافيك ربي 🌹", "ممتاز": "شكراً لك 🌟", "رائع": "يعجبني هذا 🌸", "جميل": "روعة 🌹", "الله يبارك فيك": "وفيك بارك الله 🙏", "تقبل مروري": "نورتنا بمرورك 🌸"}
    RELIGIOUS_REPLIES = {"ما شاء الله": "تبارك الرحمن 🤍", "ماشاءالله": "تبارك الله 🌹", "ما شاء الله تبارك الله": "الله يبارك فيك 🙏", "الحمد لله": "الحمد لله دائماً وأبداً 🙏", "سبحان الله": "سبحان الله وبحمده 🌹", "سبحان الله وبحمده": "سبحان الله العظيم 🌸", "اللهم صل على محمد": "اللهم صل وسلم وبارك على نبينا محمد 🌸", "صل على النبي": "اللهم صل على محمد 🌹", "استغفر الله": "ربي اغفر لي ولوالديّ 🙏", "استغفر الله العظيم": "الله أكبر، أستغفرك وأتوب إليك 🤍", "لا اله الا الله": "لا إله إلا الله محمد رسول الله 🙏", "الله اكبر": "الله أكبر كبيراً 🌹", "الحمدلله": "الحمد لله رب العالمين 🙏", "ربي": "لبيك يا رب 🌸", "اللهم": "آمين يا رب العالمين 🤍", "سبحانه": "سبحانه وتعالى 🙏", "تعالى الله": "الله أعلى وأعلم 🌹", "بسم الله": "بسم الله الرحمن الرحيم 🤍", "توكلت على الله": "حسبي الله ونعم الوكيل 🙏", "رب العالمين": "رب السماوات والأرض 🌹", "الرحمن": "بسم الله الرحمن الرحيم 🤍", "الرحيم": "الرحيم بعباده 🙏", "الملك": "الملك القدوس 🌹", "القدوس": "سبحان القدوس 🤍", "السلام": "السلام عليكم ورحمة الله 🌸"}
    JOKE_REPLIES = {"ضحك": "😂😂", "نكتة": "مرة واحد قال للبوت: وينك؟ قال البوت: هني 👻", "مزح": "😅😅", "فكة": "😂🤣", "وناسة": "🤩🤩", "طقطقة": "😂😂", "خبلت": "هههههه 🤣", "هههه": "😂🤣", "ضحكتني": "أنا مبسوط إنك ضحكت 😊", "ههههههه": "ههههههههه 🤣😂", "ضحكك": "يضحكني حضورك 😂", "نكتة جديدة": "مرة وحدة سألت البوت: أيش تسوي؟ قال: أنشر وأحمي 🤖", "طشة": "😂😂", "مموت": "ههههه، ضحكتني 🤣", "قهقهة": "ههههههههه 😂", "ضحك عالي": "ههههههههههه 🤣", "نكتة حلوة": "أحلى نكتة هي وجودك معنا 😊", "وناسة": "جو وناسة 🤩", "اخبارك": "تضحك وتبسط 😂", "طقطقة حلوة": "هههه، طق طق 🤣", "فكه": "فكة عسل 😂", "خوش واحد": "ههههه 🤣", "موتني": "موتني ضحك 😂", "نكتة اليوم": "اليوم يومك 😊", "حلوة": "حلوتك 🤩", "ايش هالضحك": "ضحكك يفرحني 😂", "يهبل": "ههههه 🤣", "يكسر": "ههههههه 🤣😂", "مزة": "ههههه 🤣", "جو": "جو حلو 😊"}
    MOTIVATIONAL_REPLIES = {"تعبت": "إرتاح شوي، تستاهل الراحة 😊", "زعلان": "لا تزعل، كل شيء بيصير خير ❤️", "فرحان": "الله يفرح قلبك 😊", "ناجح": "ألف مبروك، تستاهل كل خير 🎉", "فائز": "مبروك الفوز، أنت تستاهل 🏆", "متعب": "خذ قسط من الراحة 🌸", "محبط": "لا تحبط، النجاح قريب 💪", "متفائل": "تفاؤلك خير 🌹", "حزين": "كل شيء سيكون بخير ❤️", "مبسوط": "أجمل شعور هو السعادة 😊", "متحمس": "حماسك جميل 🔥", "مبدع": "إبداعك رائع 🌟", "متطور": "أنت تتطور باستمرار 🚀", "طموح": "طموحك يوصلك للنجاح 💫", "ناجح": "أنت ناجح دائماً 🎉"}
    SOCIAL_REPLIES = {"كيفك": "بخير الحمد لله، وأنت؟ 🌹", "كيفك انت": "بخير، تسلم ❤️", "اخبار العائلة": "كلهم بخير، الحمد لله 🙏", "والديك": "بخير، الحمد لله 🌸", "الاهل": "الحمد لله، كلهم بخير 🌹", "الصحة": "الحمد لله على كل حال 🙏", "العمل": "الحمد لله، أموره طيبة 🌸", "الدراسة": "بالتوفيق إن شاء الله 📚", "الجامعة": "الله يوفقك يارب 🌹", "المدرسة": "بالتوفيق والنجاح 🌸", "البيت": "الحمد لله، بيتنا بخير 🙏", "السفر": "الله يسهل لك 🌹", "السيارة": "سلامتك يا رب 🚗", "السكن": "الحمد لله، مستقرين 🌸", "المال": "الحمد لله، رزق حلال 🙏", "الزواج": "الله يبارك لك 🌹", "العزوبية": "الله يرزقك الزوجة الصالحة 🙏", "الأولاد": "الله يبارك لك فيهم 🌸", "البنات": "الله يحفظهم لك 🌹", "العائلة": "الله يجمع شملكم 🤍"}
    ADMIN_REPLIES = {"ممنوع": "تم التنبيه، يرجى احترام قوانين المجموعة 🚫", "انتبه": "رجاءً انتبه للقوانين ⚠️", "قوانين": "قوانين المجموعة موجودة في الوصف 📋", "مخالفة": "تنبيه: هذا مخالف للقوانين 🚫", "تحذير": "تحذير أول، يرجى الالتزام بالقوانين ⚠️", "طرد": "سيتم تطبيق العقوبات 🚫", "حظر": "تم حظر المخالف 🚫", "كتم": "تم كتم المخالف 🔇", "سجل": "تم تسجيل المخالفة 📝", "تنبيه": "تنبيه هام يرجى قراءة القوانين 📋"}
    REQUEST_REPLIES = {"بليز": "حاضر، بس أرسل طلبك بالتفصيل 📝", "من فضلك": "تفضل، أنا هنا للمساعدة 🤖", "تكرم": "أمرك يا غالي 🌹", "لو سمحت": "تفضل، أنا جاهز 🙏", "عندي طلب": "أرسل طلبك وسأساعدك 💡", "طلب": "تفضل بطلبك 📝", "سؤال": "اسأل، وأنا هنا للإجابة ❓", "استفسار": "تفضل بالاستفسار 📋", "مساعدة": "كيف أقدر أساعدك؟ 🤖", "دعم": "أنا هنا لدعمك 💪", "شكوى": "اشرح شكوتك وسنحلها 📞", "مشكلة": "اشرح مشكلتك، سأحاول مساعدتك 💡", "اقتراح": "تفضل باقتراحك، نرحب بكل فكرة 💡", "فكرة": "شاركنا فكرتك الجميلة 🌟", "رأي": "نرحب برأيك القيم 📝"}
    ABOUT_BOT_REPLIES = {"مين انت": "أنا البوت، مساعد لإدارة المجموعات 🤖", "ايش تسوي": "أساعد في إدارة المجموعات، النشر، الأمان، والكثير 📋", "مهمتك": "تنظيم المجموعات وحمايتها من المزعجين 🛡️", "شغلك": "أنشر المنشورات، أحافظ على الأمان، وأدير القنوات 📡", "ايش تقدر": "أقدر أساعدك في إدارة القناة والمجموعة 💪", "مهاراتك": "النشر التلقائي، الأمان، الردود، والإحصائيات 📊", "شو اختصاصك": "إدارة القنوات والمجموعات بكل احترافية 🎯", "ليش انت هنا": "لأخدمكم وأساعد في تنظيم المجموعة 🌸", "عرف نفسك": "أنا بوت مساعد، تحت أمركم 🙏", "شنو فائدتك": "أسهل عليك إدارة القناة والمجموعة 🚀"}
    EXTRA_REPLIES = {"تمام": "تمام يا غالي 🌸", "اوك": "أوكي، تحت أمرك 🙏", "حاضر": "حاضر، أنا جاهز 💪", "ان شاء الله": "إن شاء الله خير 🌹", "باذن الله": "بإذن الله 🙏", "مع السلامة": "مع السلامة، تشرفنا بك 🌸", "باي": "باي، نورت 🌹", "سلام": "سلام، الله يحفظك 🙏", "ياعيني": "ياعيني عليك 🌹", "ياحلو": "حلوك الله 🌸"}
    ALL_REPLIES = {}
