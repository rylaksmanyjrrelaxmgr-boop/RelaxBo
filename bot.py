...
async def private_message_router(update, context):
    """موجه الرسائل الخاصة: يدمج إنشاء المسابقات مع المعالج الرئيسي"""
    try:
...
async def main():
    ...
    # ========== جميع الأوامر (كما كانت في نسختك الأصلية) ==========
    ...
    # ========== جميع الكولباك الأساسية (التي كانت تسجل سابقاً) ==========
