...
def main_kb(uid):
    is_admin = uid == OWNER
    kb = [
        [InlineKeyboardButton("📡 قنواتي", callback_data="chs"), InlineKeyboardButton("➕ قناة", callback_data="add_ch")],
        [InlineKeyboardButton("📥 منشورات", callback_data="add_p"), InlineKeyboardButton("📤 نشر", callback_data="pub")],
        [InlineKeyboardButton("📋 منشوراتي", callback_data="my_posts"), InlineKeyboardButton("♻️ تدوير", callback_data="recycle")],
        [InlineKeyboardButton("📊 إحصائيات", callback_data="stats"), InlineKeyboardButton("📈 ملخص", callback_data="all_stats")],
        [InlineKeyboardButton("👥 مجموعات", callback_data="grps"), InlineKeyboardButton("📊 القناة", callback_data="ch_stats")],
        [InlineKeyboardButton("🏆 مسابقات", callback_data="contests"), InlineKeyboardButton("🔗 إحالات", callback_data="ref")],
        [InlineKeyboardButton("⏰ تذكيرات", callback_data="remind"), InlineKeyboardButton("🌐 ترجمة", callback_data="trans")],
        [InlineKeyboardButton("🏆 أفضل 10", callback_data="top"), InlineKeyboardButton("📊 رتبتي", callback_data="rank")],
        [InlineKeyboardButton("🎁 تجربة", callback_data="trial"), InlineKeyboardButton("💎 اشتراك", callback_data="sub")],
        [InlineKeyboardButton("⏰ جدولة", callback_data="schedule"), InlineKeyboardButton("📤 نشر الكل", callback_data="publish_all")],
        [InlineKeyboardButton("❓ مساعدة", callback_data="help"), InlineKeyboardButton("🌐 لغة", callback_data="lang")],
        [InlineKeyboardButton("📞 دعم", callback_data="support"), InlineKeyboardButton("👨‍💻 مطور", callback_data="dev")],
        [InlineKeyboardButton("➕ للمجموعة", url=f"https://t.me/{BOT_USER}?startgroup")],
