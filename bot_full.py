...
async def health_check(request):
    ...
    return web.json_response({"status": "ok", "bot": BOT_NAME, "version": "20.0.3"})
...
async def main():
    ...
    app.add_handler(CommandHandler("report", lambda u,c: u.message.reply_text("✅ تم الإبلاغ")))
    ...
    await app.bot.set_my_commands([
        ...
        BotCommand("ping", "فحص الأداء"),
        BotCommand("reload", "تحديث الملفات"),
        ...
        BotCommand("list", "عرض المشرفين المخفيين"),
        BotCommand("ban", "حظر مستخدم"),
        BotCommand("unban", "فك حظر"),
        BotCommand("mute", "كتم مستخدم"),
        BotCommand("unmute", "فك كتم"),
        BotCommand("kick", "طرد مستخدم"),
        BotCommand("pin", "تثبيت رسالة"),
        BotCommand("unpin", "إلغاء تثبيت"),
        BotCommand("promote", "ترقية مشرف"),
        BotCommand("demote", "تنزيل مشرف"),
        BotCommand("purge", "حذف رسائل"),
        BotCommand("info", "معلومات"),
        BotCommand("warn", "تحذير مستخدم"),
        BotCommand("transfer", "نقل الملكية"),
        BotCommand("broadcast", "إذاعة (للمطور)"),
        BotCommand("lock_links", "قفل الروابط"),
        BotCommand("unlock_links", "فتح الروابط"),
        BotCommand("lock_mentions", "قفل المنشنات"),
        BotCommand("unlock_mentions", "فتح المنشنات"),
        BotCommand("slowmode", "وضع بطيء"),
        BotCommand("welcome", "رسالة ترحيب"),
        BotCommand("goodbye", "رسالة وداع"),
        ...
        BotCommand("add_reply", "إضافة رد"),
        BotCommand("remove_reply", "حذف رد"),
        BotCommand("list_replies", "عرض الردود"),
        BotCommand("log", "سجل الإجراءات"),
        BotCommand("settings", "إعدادات المجموعة"),
    ])
