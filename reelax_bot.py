...
============================================================ 
nano Procfile# ORIGINAL_OWNER: 8290212138 
nano .env# GENERATED_AT: 2026-06-18 
18:43:35
# SIGNATURE: fa486cdd7fb2c8d9 
# ============================================================ 
# ⚠️ تحذير: هذا الكود يحتوي على معلومات 
# حساسة لا تشاركه مع أي شخص غير موثوق 
# ============================================================ 
# ارفعها إلى GitHub
git add reelax_bot.py requirements.txt 
Procfile .env#!/usr/bin/env python3 git 
commit -m "رفع الكود مع المتغيرات الجاهزة 
للتشغيل"# -*- coding: utf-8 -*-
